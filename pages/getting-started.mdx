...
Our monorepo follows the [recommended Nx structure](https://nx.dev/structure/applications-and-libraries) with `apps` and `libs` folders. The `apps` folder contains our core applications, subgraphs, and infrastructure jobs. If you want to see how we utilize the libraries in the _DAOhaus Toolbox_ in our own v3 app development check out the packages in this folder.
...
| [Contract Utilities](https://github.com/HausDAO/daohaus-monorepo/blob/develop/libs/contract-utilties)            | `libs/contract-utilties`       | [@daohaus/contract-utilities](https://www.npmjs.com/package/@daohaus/contract-utilities)           |
